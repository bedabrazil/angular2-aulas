System.register(['angular2/core', 'angular2/common', './models/aluno', './models/curso', './validators/email-validator'], function(exports_1) {
    ...
    var core_1, common_1, aluno_1, curso_1, email_validator_1;
        ...
        execute: function() {
            FormAlunoComponent = (function () {
                function FormAlunoComponent(fb) {
                    ...
                    this.cursos = [
                        new curso_1.Curso('angular', 'Angular 2'),
                        new curso_1.Curso('javascript', 'Javascript'),
                        new curso_1.Curso('ruby', 'Ruby on Rails')
                    ];
                    this.buildForm(fb);
                }
